...
### NULLA assistant seam

- `CaseAssistantService` captures the NULLA integration point without shipping any AI. The default `NoopCaseAssistantService` does nothing while keeping the dependency graph ready.
